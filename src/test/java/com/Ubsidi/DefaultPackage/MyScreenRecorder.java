...
package com.Ubsidi.DefaultPackage;     //Jis package me ye class hai , uss package ka name
...
public class MyScreenRecorder extends ScreenRecorder   {
	...
	public static void startRecording(String methodName) throws Exception {
		File file = new File("./recordings/");  //create recording folder under your project
